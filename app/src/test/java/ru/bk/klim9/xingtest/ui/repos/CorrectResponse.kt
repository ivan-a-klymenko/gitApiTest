...
/**
 * @author ivan.a.klymenko@gmail.com on 3/21/21
 */
object CorrectResponse {

    fun getCorrectResponse(): RepoResponse {
        if (correctJson == null || "" == correctJson) {
            return null
        }
        val type = object : TypeToken<RepoResponse>() {}.type
        return Gson().fromJson<RepoResponse>(correctJson, type)
    }
